<x-app-layout>
    <div class="py-12 bg-uw-bg" style="background-image: url('data:image/svg+xml,%3Csvg viewBox=\'0 0 200 200\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cfilter id=\'noiseFilter\'%3E%3CfeTurbulence type=\'fractalNoise\' baseFrequency=\'0.85\' numOctaves=\'3\' stitchTiles=\'stitch\'/%3E%3C/filter%3E%3Crect width=\'100%25\' height=\'100%25\' filter=\'url(%23noiseFilter)\' opacity=\'0.05\'/%3E%3C/svg%3E');">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-10 border-b-4 border-uw-border pb-6">
                <h2 class="font-serif font-black text-4xl text-uw-text uppercase tracking-tighter bg-uw-card px-4 py-2 border-4 border-uw-border shadow-brutal inline-flex items-center gap-3">
                    <span class="w-4 h-4 bg-red-500 rounded-full animate-pulse border-2 border-uw-border"></span>
                    TRANSMISIONES
                </h2>
                <p class="font-mono text-sm opacity-60 text-uw-text bg-uw-card px-3 py-1 border-2 border-uw-border whitespace-nowrap">[ FREQ: 94.3_MHZ // ACTIVE ]</p>
            </div>
