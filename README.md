...
Sigue estos pasos en tu terminal para levantar el entorno de desarrollo en tu máquina:
...
**Para el backend (Abre una terminal):**

php artisan serve

**Para el frontend (Abre otra terminal diferente):**

npm run dev

🤝 Contribución
Actualmente el proyecto está en fase de desarrollo principal. Si quieres contribuir, abre un Issue o envía un Pull Request en la rama de desarrollo.
